...
#>  8 IBGE     Base Popul… BR            FALSE          FALSE       fetch  FALSE   
#>  9 PCE      PCE - Prog… UF            FALSE          TRUE        fetch  FALSE   
#> 10 PO       PO - Paine… BR            FALSE          FALSE       fetch  FALSE   
#> 11 RESP     RESP - Not… UF            FALSE          TRUE        fetch  FALSE   
#> 12 SIASUS   SIASUS - S… UF            TRUE           TRUE        fetch  TRUE    
#> 13 SIHSUS   SIHSUS - S… UF            TRUE           TRUE        fetch  TRUE    
#> 14 SIM      SIM - Sist… TT            FALSE          TRUE        fetch  TRUE    
#> 15 SINAN    SINAN - Si… BR            FALSE          FALSE       fetch  FALSE   
#> 16 SINAN_P  SINAN prel… BR            FALSE          FALSE       fetch  FALSE   
#> 17 SINASC   SINASC - S… TT            FALSE          TRUE        fetch  TRUE    
#> 18 SISPREN… SISPRENATA… UF            TRUE           TRUE        fetch  FALSE   
```
